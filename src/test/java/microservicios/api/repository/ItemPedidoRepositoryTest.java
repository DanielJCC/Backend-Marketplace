...
class ItemPedidoRepositoryTest extends AbstractIntegrationDBTest {
    ...
    @Autowired
    public ItemPedidoRepositoryTest(ProductoRepository productRepository, ItemPedidoRepository itemPedidoRepository, PedidoRepository pedidoRepository){
    ...
    void findByProductId() {
        ...
        List<ItemPedido> items = itemPedidoRepository.findByProductoId(id_product);
        assertThat(items.size()).isEqualTo(1);
        assertThat(items.get(0).getProducto().getId()).isEqualTo(id_product);
    }
    ...
    void getTotalVentasByProductId() {
        ...
        Float totalGananciaCamisa = itemPedidoRepository.findTotalVentasByProducto(id_camisa);
        Float totalGananciaZapato = itemPedidoRepository.findTotalVentasByProducto(id_zapato);
