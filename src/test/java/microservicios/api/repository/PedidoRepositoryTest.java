...
class PedidoRepositoryTest extends AbstractIntegrationDBTest {
    ...
    void setUp() {
        ...
        pedidoGlobal1 = Pedido.builder()
                ...
                .status("ENTREGADO")
                .cliente(clienteGlobal1)
                .itemsPedidos(List.of(itemPedidoGlobal1))
                .build();
        ...
        pedidoGlobal2 = Pedido.builder()
                ...
                .status("PENDIENTE")
                .cliente(clienteGlobal1)
                .itemsPedidos(List.of(itemPedidoGlobal2))
                .build();
        ...
        pedidoGlobal3 = Pedido.builder()
                ...
                .status("ENTREGADO")
                .cliente(clienteGlobal1)
                .itemsPedidos(List.of(itemPedidoGlobal3))
                .build();
    ...
    void test_save(){
        ...
        assertThat(pedidoGuardado.getStatus()).isEqualTo("ENVIADO");
    }
