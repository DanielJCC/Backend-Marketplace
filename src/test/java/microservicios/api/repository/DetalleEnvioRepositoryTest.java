...
class DetalleEnvioRepositoryTest extends AbstractIntegrationDBTest {
    ...
    void test_findByPedidoId() {
        ...
        DetalleEnvio detalleEnvioEncontrado = detalleEnvioRepository.findByPedidoId(idPedido);

        assertThat(detalleEnvioEncontrado).isNotNull();
        assertThat(detalleEnvioEncontrado.getPedido().getId()).isEqualTo(idPedido);
        assertThat(detalleEnvioEncontrado.getId()).isEqualTo(detalleEnvioGlobal1.getId());
    }
    ...
    void findByPedido_Status() {
        List<DetalleEnvio> detallesEnvioEnPendiente = detalleEnvioRepository.findByPedidoStatus("PENDIENTE");
        assertThat(detallesEnvioEnPendiente.size()).isEqualTo(2);
        assertThat(detallesEnvioEnPendiente.get(0).getPedido().getStatus()).isEqualTo("PENDIENTE");
    }
    ...
    void test_read() {
        ...
        System.out.println(todosLosDetalles.get(0).getDireccion());
